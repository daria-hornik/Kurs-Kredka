...
namespace EntityFrameworkLab4
{
    public partial class FormMain : Form
    {
        ...
        /// <summary>
        /// ładowanie skoczków do dataGrid
        /// </summary>
        ...
        private void buttonJumperShow_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("kraj pochodzenia skoczka: " + showJumper.Country.Name);
        }
        ...
        private void buttonCountryShow_Click(object sender, EventArgs e)
        {
            ...
            labelXDDD.Text = _countries.GetById(deleteJumper.CountryId).show();
        }
        /// <summary>
        ...
        private void buttonJumperAdd_Click(object sender, EventArgs e)
        {
            ...
            Jumper newJumper = new Jumper
            {
                ...
                BirthData = Convert.ToDateTime(jumperBirthdate),
                CountryId = Int32.Parse(countryId)
            };

            newJumper.Country = _countries.GetById(Int32.Parse(countryId));

            _jumpers.Create(newJumper);
            _jumpers.Save();

            //wyświetla zaaktualizowaną listę skoczków 
            LoadJumpers();
